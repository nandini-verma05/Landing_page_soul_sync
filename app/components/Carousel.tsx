...
const planets: CarouselItem[] = [
  { name: 'Mercury', desc: 'Closest to the Sun', img: '/Crousal/planets/mercury.jpg' },
...
const zodiac: CarouselItem[] = [
  ...
  { name: 'Scorpio', desc: 'The Scorpion', img: '/Crousal/zodiac/scorpian.jpg' },
  { name: 'Sagittarius', desc: 'The Archer', img: '/Crousal/zodiac/sagittarius.jpg' },
  { name: 'Capricorn', desc: 'The Goat', img: '/Crousal/zodiac/capricorn.jpg' },
  { name: 'Aquarius', desc: 'The Water Bearer', img: '/Crousal/zodiac/aquarius.jpg' },
  { name: 'Pisces', desc: 'The Fish', img: '/Crousal/zodiac/pisces.jpg' }
];

const CarouselItem: React.FC<{ item: CarouselItem }> = ({ item }) => (
  <div className="flex-shrink-0 w-[100px] h-[100px] relative rounded-2xl overflow-hidden cursor-pointer transition-all duration-300 hover:scale-110 hover:shadow-[0_0_15px_rgba(255,255,255,0.3)] hover:z-10">
    <img 
      src={item.img} 
      alt={item.name}
...
const Carousel: React.FC = () => {
  return (
    <div className="bg-black h-screen flex flex-col justify-center overflow-hidden m-0 py-[2mm] gap-[2mm]">
      <style jsx>{`
